import os
import numpy as np
import dafy.projects.superrod.core.models.structure_tools.sxrd_dafy as model
from dafy.projects.superrod.core.models.utils import UserVars
from dafy.projects.superrod.core.models.structure_tools import tool_box
from dafy.projects.superrod.core.models.structure_tools import sorbate_tool_beta as sorbate_tool
import dafy.projects.superrod.core.models.setup_domain_hematite_rcut as setup_domain_hematite_rcut
from dafy.core.util.UtilityFunctions import config_file_parser_bv, setup_raxr_pars_new
...
batch_path_head = batch_path_head / 'Cu100'
#/path/end#
#/bv/begin#
USE_BV = False
#/bv/end#
