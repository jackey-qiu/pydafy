...
import dafy.projects.superrod.core.models.sxrd_new1 as model
...
import dafy.core.util.accessory_functions.make_par_table.make_parameter_table_GenX_5_beta as make_grid
...
batch_path_head=abs(batch_path_head / 'Muscovite001')
#/path/end#
#/wavelength/begin#
wal=0.551
#/wavelength/end#
